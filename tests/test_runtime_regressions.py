...
def test_protocol_fidelity_gate_rejects_loss_of_operational_source_detail(tmp_path):
    ...
    model = {
        "protocol": [
            ...
            {"section_id": "financial-injury", "paragraphs": [{"text": f'{reference["risks_benefits"]["injury_handling"]} {reference["risks_benefits"]["compensation_or_reimbursement"]}'}], "lists": []},
            ...
            {"section_id": "risks-benefits.benefits", "paragraphs": [{"text": reference["risks_benefits"]["benefits"]}], "lists": []},
        ],
        "icf": {},
        "prs": {},
    }

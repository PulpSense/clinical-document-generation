...
Future Hermes clinical-document runs target 10–20 minutes and have one persisted 30-minute ceiling. Environment and tooling failures must not prevent construction of a complete branch candidate, but client delivery remains atomic and requires mandatory Visual QA.
